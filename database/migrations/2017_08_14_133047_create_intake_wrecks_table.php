...
class CreateIntakeWrecksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('intake_wrecks', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('intake_wrecks', function($table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('intake_wrecks');
