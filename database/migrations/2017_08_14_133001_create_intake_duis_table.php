...
class CreateIntakeDuisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('intake_duis', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('intake_duis', function($table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('intake_duis');
